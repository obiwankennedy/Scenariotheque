...
Les caméras sont en pannes sur cette parti du port.
...
# Le SAD arrive et embarque Anita
...
Bennett explique qu'il a trouvé des traces d'ADN de Anita un peu partout sur le corps. [Poser le doute sur le sens du devoir de Anita]
...
Révelation de l'identité du mort. Enzo. La flic doit essayer de s'en sortir. 
...
Il peut laisser l'enquete continuer, ou désaisir Anita de l'enquete pour implication personnelle.
...
bref, Anita doit reveler des éléments de son bg aux autres joueurs:
...
On previendra qu'un certain Mike [nom de famille] a fait le coup. c'est un type dangereux et il a du soutien.
...
Clairement, Peneloppe est le point faible, dans le petit bizness.
